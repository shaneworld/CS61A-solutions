...
def always_roll(n):
    ...
    assert n >= 0 and n <= 10
    # BEGIN PROBLEM 6
    def strategy(current, opponent_score):
        return n
    return strategy 
    # END PROBLEM 6
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    value_list = []
    while i <= 10:
        value_list.append(make_averaged(roll_dice, total_samples)(i, dice))
        i += 1
    maximun = max(value_list)
    return value_list.index(maximun) + 1
    # END PROBLEM 9
